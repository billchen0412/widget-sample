...
Upload the widget.js to somewhere that is public.

Insert this part of code into html <head> tag
```
<script src="https://cdn.yourdomain.com/widget.js" defer></script>
<script>
    window.onload = function() {
        window.renderAIWidget({
            title: "Chat with Us!",
            thumbnail: "https://yourwebsite.com/avatar.png",
            questions: ["What are your services?", "Tell me about pricing"]
        });
    };
</script>
```